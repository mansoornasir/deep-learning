...
#Reading the dataset
def read_dataset():
    df = pd.read_csv("D:\\tensorflow\\Dataset\\IRIS.csv")
...
biases = {
    'b1': tf.Variable(tf.truncated_normal([n_dim, n_hidden_1])),
    'b2': tf.Variable(tf.truncated_normal([n_dim, n_hidden_2])),
    'b3': tf.Variable(tf.truncated_normal([n_dim, n_hidden_3])),
    'b4': tf.Variable(tf.truncated_normal([n_dim, n_hidden_4])),
...
print("Model saved i nfile: %s" % save_path)
